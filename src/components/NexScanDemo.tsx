                                ...
                                {step === 'upload' && (
                                    <div className="text-center space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <h3 className="text-2xl font-black text-white uppercase italic">Nex-Scan™ Neural Triage</h3>
                                            <p className="text-slate-500 text-sm font-medium">Upload a patient photo to test Aura's 12ms neural diagnosis engine.</p>
                                        </div>
                                        <div
                                            onClick={startScan}
                                        ...
                                        >
                                            ...
                                            <span className="text-[9px] font-black uppercase tracking-widest text-slate-600 font-prestige">Drop Medical Photo or Click</span>
                                        </div>
                                    </div>
                                )}
                                ...
                                {step === 'scanning' && (
                                    <div className="text-center space-y-10 py-6">
                                        ...
                                        <div className="space-y-4">
                                            <div className="text-xl font-black text-white italic uppercase tracking-tight">Scanning Pixels... {progress}%</div>
                                            ...
                                            <div className="text-[8px] font-black text-slate-600 uppercase tracking-[0.4em]">Nex-Scan Alpha Engine Active</div>
                                        </div>
                                    </div>
                                )}
                                {step === 'result' && (
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-center justify-between border-b border-white/5 pb-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="text-lg font-black text-white uppercase italic leading-none">Analysis Complete</h3>
                                                    <p className="text-[#00F0FF] text-[8px] font-black tracking-widest uppercase mt-1">Lead Score: 98/100</p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest leading-none mb-1">Latency</div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="p-4 bg-white/[0.02] rounded-xl border border-white/5 space-y-1">
                                                <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest">Diagnosis</div>
                                                <div className="text-[10px] font-bold text-white uppercase tracking-tight">Norwood Type IV</div>
                                            </div>
                                            <div className="p-4 bg-white/[0.02] rounded-xl border border-white/5 space-y-1">
                                                <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest"> grafts Est.</div>
                                                <div className="text-[10px] font-bold text-white uppercase tracking-tight">3,500 - 4,000 FUE</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative h-20 bg-black/40 rounded-xl border border-white/5 overflow-hidden group">
                                            ...
                                            <div className="relative z-10 h-full flex items-center justify-around px-2">
                                                <div className="text-center">
                                                    <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest">Viability</div>
                                                    <div className="text-xs font-black text-white italic">94.2%</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest">Density</div>
                                                    <div className="text-xs font-black text-white italic">82/cm²</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-[6px] font-black text-slate-600 uppercase tracking-widest">Confidence</div>
                                        ...
                                        <div className="p-5 bg-[#00F0FF]/[0.01] border border-[#00F0FF]/10 rounded-xl space-y-2">
                                            <div className="flex items-center justify-between">
                                                <h4 className="text-[7px] font-black text-[#00F0FF] tracking-widest uppercase">Autonomous Strategy</h4>
                                            ...
                                            <p className="text-[10px] text-slate-500 leading-relaxed font-medium italic">
                                                "Patient motivated. Strategic nudge sent via WhatsApp."
                                            </p>
                                        </div>
