...
export default function CoreModules() {
    return (
        <section
            id="siber-cekirdek"
            className="relative w-full py-24 bg-[#050505] overflow-hidden min-h-screen flex flex-col justify-center border-t border-b border-white/5"
        >
            {/* Yarı saydam büyük filigran (Watermark) */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] z-0 opacity-[0.03] pointer-events-none flex items-center justify-center mix-blend-screen">
                <Image
                    src="/logo.png"
            ...
            <div className="absolute inset-0 z-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_10%,transparent_100%)]"></div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                    {MODULES.map((module, idx) => (
                        <div
                            key={module.id}
                            className={`group relative p-6 bg-black/40 border ${module.borderColor} rounded-2xl backdrop-blur-sm overflow-hidden flex flex-col justify-between h-[220px] shadow-[0_4px_20px_rgba(0,0,0,0.5)] transition-all hover:scale-[1.02] hover:bg-black/60`}
